...
Wait for the user to complete each instruction and ask any clarifying questions before giving the next one. A single plan step may take many instructions to complete.

Only mark the step complete in the plan (check the checkbox) when ALL instructions for that step are done. Then tell the user what the next step is.
